...
public final class TeleopScreenBinding implements ViewBinding {
  ...
  private TeleopScreenBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RadioGroup ScoredCounterToggle, @NonNull RadioButton ScoredMinus,
      @NonNull RadioButton ScoredMinus10, @NonNull RadioButton ScoredMinus5,
      @NonNull RadioButton ScoredPlus, @NonNull RadioButton ScoredPlus10,
      @NonNull RadioButton ScoredPlus5, @NonNull RadioButton Scoredounter,
      @NonNull TextView ScoringTitle, @NonNull RadioGroup SuccessfulClimbed,
      @NonNull TextView SuccessfullyClimbed, @NonNull RadioGroup SuccessfullyClimbedLocation,
      @NonNull LinearLayoutCompat SwitchWrapper, @NonNull TextView TeleopSeconds,
  ...
  public static TeleopScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TeleopScreenBinding((ConstraintLayout) rootView, AchievedLevel1, AchievedLevel2,
          ...
          ColumnOne, ColumnThree, ColumnTwo, DidNotAttempt, FerryingCounter, FerryingCounterToggle,
          FerryingDesc, FerryingMinus, FerryingMinus10, FerryingMinus5, FerryingPlus,
          FerryingPlus10, FerryingPlus5, FerryingTitle, FixedBottom, IDTeleopSeconds1, Left,
          MissedCounter, MissedCounterToggle, MissedDesc, MissedMinus, MissedMinus10, MissedMinus5,
          MissedPlus, MissedPlus10, MissedPlus5, MissedTitle, NextButtonEndGame, NoShowSwitch,
          NoShowText, ResetButton, Right, SaveButton, ScoredCounterToggle, ScoredMinus,
          ScoredMinus10, ScoredMinus5, ScoredPlus, ScoredPlus10, ScoredPlus5, Scoredounter,
          ScoringTitle, SuccessfulClimbed, SuccessfullyClimbed, SuccessfullyClimbedLocation,
          SwitchWrapper, TeleopSeconds, TimerBox, TowerClimbPlacement, autonFieldContainer,
          bottomEdgeBar, endgameWarning, leftEdgeBar, rightEdgeBar, topEdgeBar);
    }
